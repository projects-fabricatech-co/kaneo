...
Vale Desconto vive **dentro do monorepo do Kaneo**, mas é um produto separado:
banco de dados próprio, autenticação própria, portas próprias. Não compartilha
nenhuma tabela nem nenhuma sessão com o Kaneo.
