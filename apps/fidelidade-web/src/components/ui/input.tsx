...
function Input({
  ...
  return (
    ...
    >
      {nativeInput ? (
        // Base UI's prop type allows state-function values for `style` and
        // `className`, which a plain DOM <input> cannot accept. The escape hatch
        // is narrowed here rather than in the public prop type: `nativeInput` is
        // the rare branch, and callers using it pass plain values.
        <input
